    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            products.forEach(imte => {
                var nums = imte.pprice * imte.pnum;
                str += `
                <div class="cart-heads">
                    ...
                    <div class="messages">
                        ...
                        <div class="messages-rig">
                            <span class="span-one">${imte.pname}</span>
                            <span class="span-three">￥${imte.pprice}/件</span>
                        </div>
                    </div>
                    <ul class="oUls">
                        <li class="one" style="display:none">${imte.pprice}</li>
                        <li class="two">
                            <button class="reduce" data-id="${imte.pid}">-</button>
                            <input type="text" value="${imte.pnum}" class="ipt" data-num="${imte.pnum}">
                            <button class="add" data-id="${imte.pid}">+</button>
                        </li>
                        <li class="three">￥${nums}</li>
                        <li class="four">
                            <button class="delBtn" data-id="${imte.pid}" >[删除]</button>
                        </li>
                    </ul>
                </div>
        `
